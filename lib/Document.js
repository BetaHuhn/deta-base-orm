    ...
    */
    constructor(data, _baseSchema) {
        ...
        const documentData = Object.assign(Object.assign(Object.assign({}, data), { 
            ...
            key: data.key || random_1.generateKey(Document._opts.ascending) }), (Document._opts.timestamp || data.createdAt && { createdAt: data.createdAt || Date.now() }));
    ...
    */
    update(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            delete data.key;
            yield Document._db.update(data, this.key);
            const newData = yield Document._db.get(this.key);
            this._data = newData;
